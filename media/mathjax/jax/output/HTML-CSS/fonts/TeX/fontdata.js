...
(function(i, b, q) {
    ...
    i.FONTDATA.FONTS.MathJax_Main[8942][0] += 400;
    i.FONTDATA.FONTS.MathJax_Main[8945][0] += 700;
    i.FONTDATA.FONTS.MathJax_Size4[57684][0] += 200;
    i.FONTDATA.FONTS.MathJax_Size4[57684][1] += 200;
    i.FONTDATA.FONTS.MathJax_Main[8773][2] -= 222;
    i.FONTDATA.FONTS.MathJax_Main[8773][5] = {
        rfix: -222
    };
    MathJax.Hub.Register.LoadHook(i.fontDir + "/Main/Bold/MathOperators.js", function() {
        i.FONTDATA.FONTS["MathJax_Main-bold"][8773][2] -= 106;
        i.FONTDATA.FONTS["MathJax_Main-bold"][8773][5] = {
            rfix: -106
        }
    });
    ...
    MathJax.Hub.Insert(i.FONTDATA.FONTS.MathJax_Main, {
        61152: [0, 0, -575, 0, 0, {
            space: 1
        }],
        61153: [0, 0, -300, 0, 0, {
