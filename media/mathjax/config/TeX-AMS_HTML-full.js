...
(function(f, n, p, e, q) {
    ...
    var g = MathJax.Menu = h.Subclass({
        ...
        Post: function(u, I, G) {
            ...
            for (var B = 0, z = this.items.length; B < z; B++) {
        ...
        IndexOf: (Array.prototype.indexOf ? function(t, u, v) {
            ...
            for (var v = (x || 0), u = t.length; v < u; v++) {
                if (w === t[v]) {
                    return v
                }
            }
    ...
    g.ENTRY = g.ITEM.Subclass({
        ...
        MoveVertical: function(t, D, v) {
            ...
            var C = [];
            for (var y = 0, B = w.menuItem.items, x; x = B[y]; y++) {
                if (!x.hidden) {
                    C.push(x)
                }
            }
    ...
    g.About = function(x) {
        ...
        t.push(["div", {
            ...
            [f.Browser + " v" + f.Browser.version + (z ? " \u2014 " + s(z.replace(/ /g, ""), z) : "")]
        ]);
        ...
        var w = n.addElement(g.About.div, "div", {
            ...
            ["b", {
                ...
                ["MathJax"]
            ], " v" + MathJax.version, ["br"], s(u.replace(/ /g, ""), "using " + u), ["br"],
            ["br"],
            ["span", {
                style: {
                    display: "inline-block",
    ...
    g.CreateLocaleMenu = function() {
        ...
        for (var w = 0, t = u.length; w < t; w++) {
            ...
            y.items.push(c.RADIO([u[w], x], "locale", {
                action: g.Locale
            }))
        }
    ...
    f.Register.StartupHook("End Config", function() {
        ...
        g.menu = g(c.SUBMENU(["Show", "Show Math As"], c.COMMAND(["MathMLcode", "MathML Code"], g.ShowSource, {
            ...
            action: g.Renderer,
            value: "PlainSource"
        }), c.RULE(), c.CHECKBOX(["FastPreview", "Fast Preview"], "FastPreview"), c.CHECKBOX(["AssistiveMML", "Assistive MathML"], "assistiveMML", {
            action: g.AssistiveMML
        }), c.CHECKBOX(["InTabOrder", "Include in Tab Order"], "inTabOrder")), c.SUBMENU("MathPlayer", {
...
(function(h, b, d) {
    ...
    d.Augment({
        ...
        preTranslate: function(q) {
            var p = q.jax[this.id],
                B, x = p.length,
                w, E, u, A, s, C, l, D, k, F, t, r = false,
                y, o = this.config.linebreaks.automatic,
